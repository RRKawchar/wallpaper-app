...
class HousesScreens extends StatefulWidget {
  @override
  _HousesScreensState createState() => _HousesScreensState();
}

class _HousesScreensState extends State<HousesScreens> {
